...
//        denominations.push_back(6);
//        denominations.push_back(12);
//        denominations.push_back(24);
//        denominations.push_back(48);
//        denominations.push_back(60);

        for(int jk = 2; jk <= 30; jk=(jk+2)) {
            denominations.push_back(jk);
        }
        ...
        for(int i = 2000; i <=2200; i++) {
            ...
            for(int k = 0; k < (denominations.size() - 1); k++) {
                myChange.coins[k] = 0;
            }
        }
